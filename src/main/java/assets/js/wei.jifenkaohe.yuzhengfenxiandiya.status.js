...
$(function () {
    ...
    window['g'] =
        manager = $("#maingrid").ligerGrid({
                ...
                //pageSize: 20,
                url: '/api/jifenkaohe/yuzhengke/yuzhengfengxiandiyazhuangtai/' + id,
                height: '97%',
                width: '100%',
                record: 'total',
...
function setItem() {
    ...
    $.ligerDialog.open({
        ...
        width: 900,
        title: '展示数据',
        url: '/jifenkaohe/yuzhengke/yuzhengfengxiandiya/jifenluru/' + selectedId,
        showMax: true,
        showToggle: true,
        showMin: false,
        isResize: true,
...
function showData(rowdata, rowid) {
    var jianquID = rowdata.jianquid;
    if (rowdata.state == "录入中") {
        return "<a href='/jifenkaohe/yuzhengke/yuzhengfengxiandiya/jifenluru/show/" + jianquID + "'><b>查看</b></a>"
    } else {
        return "<a href='/jifenkaohe/yuzhengke/yuzhengfengxiandiya/jifenluru/" + jianquID + "'><b style='color: red'>录入</b></a>"
    }
}
