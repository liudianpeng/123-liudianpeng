    ...
    window['g'] =
        manager = $("#maingrid").ligerGrid({
                columns: [
                    ...
                    { display: '查看', name: 'show',isSort:false, width:300,minWidth:300, align: 'center',render:function(rowdata){
                        var selectId=rowdata.id;
                        //console.log(selectId);
                        return "<a href='/jifenkaohe/yuzhengke/yuzhengfengxiandiya/status/"+selectId+"'><b>查看</b></a>"
                    }}
                ],
                checkbox:false,
