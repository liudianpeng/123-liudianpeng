...
$(function () {
    ...
    var fanzuileixing = dialogData.fanzuileixing;

    var api;

    api = '/api/xinxiguanli/welcome/statistics_detail/fanzuileixing/' + jianquId + "/" + fenjianquId + '/' + fanzuileixing
    ...
    window['g'] =
        manager = $("#maingrid").ligerGrid({
                columns: [
                    ...
                    {display: '犯罪类型', name: 'syzm', width: 340, type: 'text'}
                ],
