...
$(function () {
    ...
    var fenyaleixing = dialogData.fenyaleixing;

    var api;

    api = '/api/xinxiguanli/welcome/statistics_detail/fenyaleixing/' + jianquId + "/" + fenjianquId + '/' + fenyaleixing
    ...
    window['g'] =
        manager = $("#maingrid").ligerGrid({
                columns: [
                    ...
                    {display: '分押类型', name: 'fylx_name', width: 340, type: 'text'}
                ],
