...
{
    var a = new Array();
    $.getJSON("/api/xitongguanli/role/list", function(res){
        var items=res['items'];
        ...
        $.getJSON("/api/xitongguanli/group/show/"+dialogData.id, function(res){
...
function save(){
    ...
    var postData={roleId:shouldSaveDataArray};
    ...
    $.ajax({
        type: 'POST',
        url: '/api/xitongguanli/group/role/maintains/'+dialogData.id,
        data: postData,
        success: function(res){
            ...
            if(res.notice=='success'){
                ...
                $(".notice_sucess",window.parent.document).html("角色设定成功！");
