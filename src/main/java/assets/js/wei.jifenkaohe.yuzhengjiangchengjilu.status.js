    ...
    window['g'] =
        manager = $("#maingrid").ligerGrid({
            ...
            toolbar: {
                ...
                //pageSize: 20,
                url: '/api/jifenkaohe/yuzhengke/yuzhengjiangchengjiluzhuangtai/' + id,
                height: '97%',
                width: '100%',
                record: 'total',
...
function setItem() {
    ...
    $.ligerDialog.open({
        ...
        width: 900,
        title: '展示数据',
        url: '/jifenkaohe/yuzhengke/yuzhengjiangchengjilu/jifenluru/' + selectedId,
        showMax: true,
        showToggle: true,
        showMin: false,
        isResize: true,
...
function showData(rowdata, rowid) {
    ...
    if (rowdata.state == "录入中") {
        return "<a href='/jifenkaohe/yuzhengke/yuzhengjiangchengjilu/jifenluru/" + jianquID + "'><b style='color: red'>录入</b></a>"
    } else {
        return "<a href='/jifenkaohe/yuzhengke/yuzhengjiangchengjilu/show/" + jianquID + "'><b>查看</b></a>"
    }
}
