...
window.FlexPaperViewerEmbedding = window.$f = function(id, args) {
    ...
    _jsDirectory 		= (config.jsDirectory!=null?config.jsDirectory:"/assets/vendor/FlexPaper/js/");
    _cssDirectory 		= (config.cssDirectory!=null?config.cssDirectory:"/assets/vendor/FlexPaper/css/");
    _localeDirectory 	= (config.localeDirectory!=null?config.localeDirectory:"/assets/vendor/FlexPaper/locale/");
    if(_SWFFile!=null && _SWFFile.indexOf("{" )==0 && _SWFFile.indexOf("[*," ) > 0 && _SWFFile.indexOf("]" ) > 0){_SWFFile = escape(_SWFFile);} // split file fix

    window[instance] = flashembed(id, {
        src						    : _jsDirectory+"../FlexPaperViewer.swf",
        version					    : [10, 0],
        expressInstall			    : "/assets/vendor/FlexPaper/js/expressinstall.swf",
        wmode					    : _WMode
    },{
        ElementId               : id,
        SwfFile  				: _SWFFile,
